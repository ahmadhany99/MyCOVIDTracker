...
export { createAccountPatient, createAccountAdmin, getAccountByEmail, getAccountByID, getAllAccount, deleteAccountByID, getAccountByTypeDoctor, getAccountByTypePatient };
